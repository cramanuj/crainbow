...
for(i in 1:length(seu_list)){
  ...
  seu = ScaleData(seu, display.progress = F,vars.to.regress = c("nUMI","CC.Difference"))
...
cca_out = FindClusters(cca_out, reduction.type = "cca.aligned", resolution = c(0.6), dims.use = 1:dim_max,print.output = F)
