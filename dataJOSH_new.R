...
# cca_out_umap = RunUMAP(cca_out,reduction.use="cca.aligned",seed=1234,n_neighbors = 30L,min_dist = 0.05)
# DimPlot(cca_out_umap,reduction.use = 'umap')
